...
- Run tests with coverage (wildcards allowed): `Invoke-PesterJob -Output minimal -Path '{tests filepath}' -EnableSourceLineMapping -FilterCodeCoverageResult '{function/command name pattern}'`
